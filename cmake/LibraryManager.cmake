...
macro(_semver)
    if (ARG_VERSION)
        ...
        if (ARG_DEFAULT_VERSION)
            ...
            message(DEBUG "defaulted PROJECT_VERSION=${PROJECT_VERSION}")
        else ()
                ...
                if ("${name}" STREQUAL "LAPACK")
                    ...
                    if ("${BLA_VENDOR_FOUND}" STREQUAL "Apple" OR "${BLA_VENDOR_FOUND}" STREQUAL "OpenBLAS" OR LAPACK_LIBRARIES MATCHES "liblapack.") # special subversion to use generic lapacke together with Accelerate or generic
                        ...
                        if (NOT _private_lapacke_lib)
                            message(FATAL_ERROR "Cannot find lapacke library in $ENV{HOMEBREW_PREFIX}/opt/lapack/lib or /opt/local/lib. Install lapack package from homebrew or macports.")
                        endif ()
