    ...
    if (NOT TARGET ${name}::${name})
        ...
        foreach (BLA_VENDOR ${vendors} "")
            ...
            if (${name}_FOUND)
                ...
                if ("${BLA_VENDOR_FOUND}" STREQUAL "Apple")
                    target_compile_definitions(${name}::${name} INTERFACE "-DACCELERATE_NEW_LAPACK")
                endif()
                ...
                if ("${name}" STREQUAL "BLAS" AND NOT "${BLA_VENDOR_FOUND}" STREQUAL "Apple")
